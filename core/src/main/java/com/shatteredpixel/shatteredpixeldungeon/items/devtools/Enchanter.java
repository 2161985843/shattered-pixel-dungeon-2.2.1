...
import static com.shatteredpixel.shatteredpixeldungeon.items.devtools.EnchRecipe.appendd;
                            ...
                            if (recipe != null) {
                                ...
                                if (!buffClasses.isEmpty()) {
                                    ...
                                    for (Buff buff : hero.buffs()) {
                                        if (buff.getClass() == firstBuffClass) {
                                            hasBuff = true;
                                            break;
                                        }
                                    }
...
//            }
        ...
        protected WndBag.ItemSelector inputSelector = new WndBag.ItemSelector() {
            ...
            public boolean itemSelectable(Item item) {
                return item instanceof Limb ; // 只允许选择近战武器
            }
            @Override
